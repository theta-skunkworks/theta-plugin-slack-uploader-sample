...
import com.theta360.slackuploader.model.ImageSize;
import com.theta360.slackuploader.network.HttpConnector;
import com.theta360.slackuploader.network.HttpEventListener;
...
public class TakePictureTask extends AsyncTask<Void, Void, HttpConnector.ShootResult> {
    ...
    protected HttpConnector.ShootResult doInBackground(Void... params) {
        ...
        camera.setImageSize(ImageSize.IMAGE_SIZE_2048x1024);
